...
const WeeklyTasks = () => {
  ...
  const tasks = [
    { id: 1, text: "practice verbal", completed: false },
    { id: 2, text: "Complete mini test", completed: false },
    { id: 3, text: "practice weak points", completed: false },
    { id: 4, text: "complete 10 lessons", completed: false },
    { id: 5, text: "practice math", completed: false },
    { id: 6, text: "review a test", completed: false },
    {
      id: 7,
      text: "finish 1 exam",
      completed: false,
